...
import net.teamfruit.catserverpatch.Log;
import net.teamfruit.catserverpatch.asm.lib.ClassName;
import net.teamfruit.catserverpatch.asm.lib.INodeTransformer;
import net.teamfruit.catserverpatch.asm.lib.INodeTreeTransformer;
import net.teamfruit.catserverpatch.asm.lib.VisitorHelper;
import net.teamfruit.catserverpatch.compat.CompatTransformer;
...
public class CatServerPatchTransformer extends CompatTransformer {
	@Override
